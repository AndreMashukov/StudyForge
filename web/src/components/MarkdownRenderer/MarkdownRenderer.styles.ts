...
export const markdownStyles = {
  ...
  h4: "text-lg font-medium text-foreground mb-2 mt-4 scroll-mt-20 break-words max-w-full",
  h5: "text-base font-medium text-foreground mb-2 mt-3 scroll-mt-20 break-words max-w-full",
  h6: "text-sm font-medium text-foreground mb-1 mt-2 scroll-mt-20 break-words max-w-full",
  
  // Text elements
  paragraph: "text-muted-foreground leading-7 mb-4 break-words max-w-full whitespace-normal",
  strong: "font-semibold text-foreground",
  em: "italic",
  
  // Lists
  ul: "list-disc list-inside space-y-1 mb-4 text-muted-foreground break-words",
  ol: "list-decimal list-inside space-y-1 mb-4 text-muted-foreground break-words",
  li: "text-muted-foreground break-words max-w-full",
  ...
  // Blockquote
  blockquote: "border-l-4 border-primary/30 pl-4 italic text-muted-foreground mb-4 bg-muted/30 py-2 rounded-r-md break-words max-w-full",
