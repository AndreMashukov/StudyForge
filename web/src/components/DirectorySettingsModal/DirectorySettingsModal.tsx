...
export const DirectorySettingsModal = ({
  ...
  const handleDetach = async (ruleId: string, ruleName: string) => {
    try {
      ...
      showToast(
        `Rule "${ruleName}" detached from "${directory.name}"`,
        'success',
      );
    } catch {
  ...
  const getApplicabilityBadges = (applicableTo: RuleApplicability[]) => {
    const badgeColors: Record<RuleApplicability, string> = {
      ...
      [RuleApplicability.CHAT]: 'bg-sky-500/10 text-sky-500',
      ...
      [RuleApplicability.SUBJECT_WORLD]: 'bg-fuchsia-500/10 text-fuchsia-500',
    };
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              ...
              Directory Settings: {directory.name}
            </DialogTitle>
                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() =>
                                console.log('View details:', rule.id)
                              }
                            >
                              View Details
                            </DropdownMenuItem>
