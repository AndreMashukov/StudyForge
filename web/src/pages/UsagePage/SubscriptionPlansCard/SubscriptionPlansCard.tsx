...
import {
  usagePlanTileCurrentClassName,
  usagePlanTileMutedClassName,
  ...
  return (
    <Card className={usageSectionCardClassName}>
      ...
      <CardContent className="space-y-4 px-5 pb-5 pt-0">
        {isLoading ? <SubscriptionPlansSkeleton /> : null}
            ...
            {plans.map((plan) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    isCurrent ? usagePlanTileCurrentClassName : usagePlanTileMutedClassName,
                  )}
                >
