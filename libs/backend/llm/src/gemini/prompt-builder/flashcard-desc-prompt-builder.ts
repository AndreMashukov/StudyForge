 ...
 */
export function buildFlashcardDescriptionRulesSection(
...
${text}
---
If the custom rules ask for code snippets in descriptionHtml, use <pre><code class="language-LANG">...</code></pre> with the best matching Prism language key.`;
  }
